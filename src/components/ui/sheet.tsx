...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-full border-l sm:w-[100%]",
          side === "left" &&
    ...
    absolute bg-[#3D456B] h-[40px] w-[40px] rounded-full top-4 right-4

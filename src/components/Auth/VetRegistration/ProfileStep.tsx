  ...
  return (
    ...
    >
      <Card className="backdrop-blur-xl bg-white/10 border-white/20 shadow-2xl border-0">
        <CardHeader>
          <CardTitle className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-blue-200 flex items-center gap-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-6">
              ...
              <FileUpload
                ...
                onFileChange={(files) =>
                  handleFileChange(files, "profilePicture")
                }
                onError={(error) =>
              ...
              <div className="space-y-2">
                <Label htmlFor="signature" className="text-blue-400">
                  Digital Signature
                </Label>
                <Textarea
                  id="signature"
              ...
              <FileUpload
                ...
                onFileChange={(files) =>
                  handleFileChange(files, "signatureImage")
                }
                onError={(error) =>
              ...
              <div className="space-y-4">
                ...
                {profileData.licenses.length === 0 ? (
                  <div className="p-4 bg-gray-300 rounded-lg border-2 border-dashed border-gray-300 text-center">
                    <p className="text-sm text-gray-700 mb-2">
                      No licenses added yet
                    </p>
                    <p className="text-xs text-gray-700">
                      Click "Add License" to add your veterinary license
                      information
                    </p>
                  </div>
                ) : (
                  <div className="space-y-4">
                    {profileData.licenses.map((license, index) => (
                      <Card
                        key={index}
                        className="backdrop-blur-xl bg-white/10 border-white/20 shadow-2xl border-0"
                      >

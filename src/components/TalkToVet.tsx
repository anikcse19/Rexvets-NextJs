  ...
  return (
    <div className="flex justify-center mr-2.5">
      <motion.button
        ...
        className="relative bg-[#113F67] text-white px-6 py-1 my-1 rounded-full font-semibold text-lg shadow-lg border-2 border-cyan-400/50 overflow-hidden cursor-pointer"
        whileHover={{
          scale: 1.02,

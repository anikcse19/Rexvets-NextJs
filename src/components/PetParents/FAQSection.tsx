      ...
      <div className="relative  mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-5">
          ...
          <p className="text-white/90 mb-6 text-lg md:text-xl leading-relaxed">
            Choose Rex Vet and give your pets the expert care they deserve,
            anytime, anywhere. Join us and experience stress-free pet parenting
            today!
          </p>
        ...
        <div className="lg:col-span-7 space-y-4">
          {faqItems.map((faq, index) => (
            ...
            >
              ...
              {/* Accordion Body */}
              <div
                className={`px-6 pb-4 text-white/90 text-sm md:text-base overflow-hidden transition-all max-h-96 duration-300 ${

...
export default function RescheduleModalDupli({
  open,
  onClose,
  appointment,
}: {
  ...
  const handleConfirm = async () => {
    ...
    try {
      ...
      await updateRescheduledAppointment(appointment.id, newAppointment);
      ...
      onClose();
      toast.success("Rescheduled Appointment updated Successfully");

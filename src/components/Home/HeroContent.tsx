  ...
  return (
    <div className="p-4 md:p-0 flex flex-col items-center justify-center text-center xl:items-start xl:justify-start xl:text-start">
      ...
      <div className="flex flex-col sm:flex-row flex-wrap gap-4 pt-4 justify-center items-center xl:justify-start xl:items-start">
        ...
        <button className=" z-50 inline-flex items-center justify-center box-border outline-none m-0 cursor-pointer select-none align-middle appearance-none no-underline font-roboto leading-[1.75] tracking-[0.02857em] min-w-[64px] rounded-full px-9 py-4 text-[16px] font-bold normal-case relative overflow-hidden transition-transform duration-300 ease-in-out bg-white/10 backdrop-blur-[20px] border-2 border-white/30 hover:border-white/60 text-white transform hover:scale-105 gap-x-2">

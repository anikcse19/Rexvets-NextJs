...
const HeroContent: React.FC = () => {
  ...
  return (
    <div className="">
      ...
      <div>
        <h1 className="text-6xl md:text-[96px]  text-center md:text-start md:leading-[106px]  font-garet font-bold text-[#FFFFFF] mb-1 md:mb-4 ">
          Low-Cost
        </h1>
        <h1 className="text-6xl md:text-[96px] md:leading-[106px] font-garet font-bold mb-2 md:mb-6 text-center md:text-start ">
      ...
      <p className="text-[17px] text-center md:text-start text-white md:text-[21px] md:leading-[33px] max-w-lg ">
      ...
      <div className="w-[90%]  mx-auto md:w-full flex flex-col sm:flex-row space-y-8 sm:space-y-0 sm:space-x-4 pt-4">
        <button
          onClick={() => router.push("/video-call")}
          className="mb-4 md:mb-0 book-consultation-button inline-flex items-center justify-center box-border outline-none border-none m-0 cursor-pointer select-none align-middle appearance-none no-underline font-roboto text-base leading-[1.75] tracking-[0.02857em] min-w-[64px] rounded-full px-9 py-4 font-bold normal-case relative overflow-hidden transition-all duration-400 ease-[cubic-bezier(0.4,0,0.2,1)] bg-gradient-to-r from-blue-500 via-purple-500 to-pink-400 text-white shadow-[0_8px_25px_rgba(59,130,246,0.4)] gap-x-2"
        >

        ...
        <div className="text-center mb-8">
          <div className="flex justify-center items-center mb-3">
            ...
            <h2 className="text-3xl md:text-4xl lg:text-[64px] font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-gray-900 via-blue-600 to-purple-600 mb-3 leading-tight">
              Why Rex Vet Offers the Best Online Pet Telehealth
            </h2>
          </div>
          <p className="text-base md:text-[16px] md:leading-[33px] font-garet text-[#455f6b] font-medium max-w-2xl mx-auto leading-relaxed px-2">

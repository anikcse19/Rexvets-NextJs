...
petParentSchema.methods.comparePassword = async function (
...
petParentSchema.methods.incrementLoginAttempts =
...
petParentSchema.statics.findByEmailVerificationToken = function (
  token: string
) {

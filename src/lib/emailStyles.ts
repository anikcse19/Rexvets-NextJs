// Common email template styles and components (ported from email server)
...
export const headerTemplate = `
  <div class="banner">
    <img src="https://res.cloudinary.com/di6zff0rd/image/upload/v1752576720/10min_tmi7yc.webp" alt="Top Banner" />
  </div>
`;
...
export const appointmentButtonTemplate = (
  meetingLink: string,
  buttonText: string = "Join Appointment Now"
) => `

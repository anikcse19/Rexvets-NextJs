      ...
      <View style={styles.container}>
        <View style={styles.headerBar}>
          <Image
            ...
            src={
              logoDataUri ||
              "data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iMTIwIiBoZWlnaHQ9IjI0IiB2aWV3Qm94PSIwIDAgMTIwIDI0IiBmaWxsPSIjZmZmIj48L3N2Zz4="
            }
          />
        </View>
        ...
        <View style={styles.body}>
          ...
          <Text style={styles.greeting}>
            Dear <Text style={{ fontWeight: "bold" }}>{donorName}</Text>,
          </Text>
          ...
          <View style={styles.receiptBox}>
            ...
            <Text style={styles.taxStatement}>
              Rex Vet Inc is a 501(c)(3) non-profit organization. No goods or
              services were received in exchange for this gift. It may be
              considered tax-deductible to the full extent of the law. Please
          ...
          <View>
            <Text style={styles.listItem}>
              • Your donation directly supports animals in need by helping us
              provide free and low-cost virtual veterinary care to pets in
              underserved communities.
            </Text>
            <Text style={styles.listItem}>
              • Every dollar helps us reach more families and save more lives —
              from emergency consultations to routine care.
            </Text>
            <Text style={styles.listItem}>
              • With your support, we're one step closer to making quality vet
              care accessible for every pet, regardless of circumstance.
            </Text>
          </View>
        ...
        <View style={styles.footerBar}>
          <Text style={styles.footerText}>Rex Vet Inc</Text>
          <Text style={styles.footerText}>
            📍 123 Animal Care Drive, Miami, FL 33101
          </Text>
          <Text style={styles.footerText}>
            EIN: (123) 456-7690 | ✉️ support@rexvet.org
          </Text>
